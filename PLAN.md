# AI Document Intelligence Service — Build Plan
...
Asynchronous processing architecture: Next.js console; Hono API; Go parser workers; Gemini adapters; PostgreSQL/Prisma plus pgvector; MongoDB document trees; object storage.
...
Next.js, TypeScript, shadcn/ui, Zustand, Hono, Go, Prisma, PostgreSQL/pgvector, MongoDB, Gemini API, Docker

## Core domain

Tenant, Document, DocumentVersion, Page, Block, Chunk, Embedding, ExtractionSchema, Extraction, Question, Answer, Citation, Job.

## API strategy

REST upload/job commands; GraphQL document queries; SSE for processing status; structured JSON extraction endpoints.
